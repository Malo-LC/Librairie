...
<head>
    ...
    <LINK rel="stylesheet" type="text/css" href="apropos.css" media="screen" />
...
<body>
	...
	<ul class="hotbar">
		...
		<li class="toolbar active left" style="float:right"><a href="Cadeaux.php">À propos</a></li>
    </ul>

<h1>Conditions générales d’utilisation du site Librairie Saint-Nicolas</h1> 
...
<p class="marge">•	Le formulaire de contact ;</p>
<p class="marge">•	Son espace client.</p></p>
<h2>Article 5 : Propriété intellectuelle</h2>
<p class="marge">Les marques, logos ainsi que les contenus du site Librairie Saint-Nicolas (illustrations graphiques, textes…) sont protégés par le Code de la propriété intellectuelle et par le droit d’auteur.
...
<p class="marge">Le site peut être constitué de liens hypertextes. En cliquant sur ces derniers, l’Utilisateur sortira de la plateforme. Cette dernière n’a pas de contrôle et ne peut pas être tenue responsable du contenu des pages web relatives à ces liens.</p>
<h2>Article 8 : Cookies</h2>
<p class="marge">Lors des visites sur le site, l’installation automatique d’un cookie sur le logiciel de navigation de l’Utilisateur peut survenir.
...
L’information présente dans les cookies est utilisée pour améliorer les performances de navigation sur le site Librairie Saint-Nicolas.fr.
...
<p class="marge">Le site Librairie Saint-Nicolas permet aux membres de publier des commentaires.
...
<p class="marge">Le présent contrat est valable pour une durée indéterminée. Le début de l’utilisation des services du site marque l’application du contrat à l’égard de l’Utilisateur.</p>
<h2>Article 11 : Droit applicable et juridiction compétente</h2>
<p class="marge">Le présent contrat est soumis à la législation française. L’absence de résolution à l’amiable des cas de litige entre les parties implique le recours aux tribunaux français compétents pour régler le contentieux.</p>
